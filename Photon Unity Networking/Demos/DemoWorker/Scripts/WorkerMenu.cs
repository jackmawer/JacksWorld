...
public class WorkerMenu : MonoBehaviour
{
    ...
    public void OnGUI()
    {
        ...
        // Join room by title
        GUILayout.BeginHorizontal();
        GUILayout.Label("Room password (leave as default if you want to join public multiplayer) ", GUILayout.Width(150));
        this.roomName = GUILayout.TextField(this.roomName);
        
        if (GUILayout.Button("Create session", GUILayout.Width(150)))
        {
        ...
        //this.roomName = GUILayout.TextField(this.roomName);
        if (GUILayout.Button("Join session", GUILayout.Width(150)))
        {
